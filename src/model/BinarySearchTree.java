...
public class BinarySearchTree<ContentType extends ComparableContent<ContentType>> {
	 ...
	 * pContent uebereinstimmendes Objekt im geordneten binaeren Suchbaum
	...
	public void remove(ContentType pContent) {
		if (!isEmpty()) { // Abbrechen, falls kein Element zum Entfernen vorhanden ist.
	...
	public ContentType search(ContentType pContent) {
		...
		if(pContent.equals(this.getContent())){
			return pContent;

		}else{
			if(!this.isEmpty()){
				if(pContent.isGreater(this.getContent())){
					getRightTree().search(pContent);

				}else if(pContent.isLess(this.getContent())){
					getLeftTree().search(pContent);
